...
<body class="bg-transparent" >
    <div class="container">
        <div class="row "> 
            ...
            <button type="button" onclick="openIframe()" class="btn  text-white" style="background-color: #7386D5;">
...
<body>
    <div class="container me-auto ms-auto m-2">
        Hey!!!!!!!!!!!!! <br>
        I am Kalpak, check out my Element code and outputs............
    </div>
